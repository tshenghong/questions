...
# MAGIC %md
# MAGIC 
# MAGIC # Single Node Data Science on Databricks 
# MAGIC 
...
# MAGIC %md 
# MAGIC #### In this demo, we are going to use Databricks ML Runtime to perform Airbnb Listing Data Analysis following the steps: Ingest &rarr; Explore &rarr; Enrich &rarr; Apply ML
# MAGIC 
...
# MAGIC %md
# MAGIC 
# MAGIC #### Let's Install `plotly` for High Quality Visualization for EDA. 
# MAGIC 
...
Single Node Data Science on Databricks
<img src="https://hackr.io/blog/top-data-science-python-libraries/thumbnail/large", width =400> <img src="https://redislabs.com/wp-content/uploads/2016/12/lgo-partners-databricks.png", width =240>

Contents

Databricks ML Runtim
...
Databricks ML RuntimSingle Node Data Science on Databricks
<img src="https://hackr.io/blog/top-data-science-python-libraries/thumbnail/large", width =400> <img src="https://redislabs.com/wp-content/uploads/2016/12/lgo-partners-databricks.png", width =240>
